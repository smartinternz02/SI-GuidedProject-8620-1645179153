...
java_skills  = ["Java","Xtend","IDE","DSL","Framework","Xtext","Git","client","XML","Editor","Maven","integration.a","Java","DSL Framework","Git","client","XML","Editor","Maven","integration"]
...
def upload_file():
    if request.method == 'POST':
        ...
        if(len(Skills_matched) >= 4 ):
            ...
            s.login("jubnanikhil143@gmail.com", "jubna1994")
            ...
            message  = 'Subject: {}\n\n{}'.format(SUBJECT, TEXT)
            s.sendmail("jubnanikhil143@gmail.com", email, message)
            s.quit()
